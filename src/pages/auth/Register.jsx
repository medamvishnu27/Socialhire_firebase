...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    ...
    if (result.meta.requestStatus === 'fulfilled') {
      ...
      console.error('Signup failed:', result.error.message); // Log error details
      setShowError(true);
    }
  };
  ...
  const handleGoogleLogin = async () => {
    ...
    if (result.meta.requestStatus === 'fulfilled') {
      console.log('Google signup successful, navigating to profile');
      navigate('/profile');
    } else {
      console.error('Google signup failed:', result.error.message);
      setShowError(true);
    }
  };
